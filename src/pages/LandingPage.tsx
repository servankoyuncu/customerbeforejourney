...
function TrackEvents({ lang }: { lang: Lang }) {
  useLandingTrackingEvents(lang);
  return null;
}
...
export function LandingPage() {
  ...
  return (
    <LandingTrackingProvider language={lang}>
      <TrackEvents lang={lang} />
      <div className="bg-white text-slate-800">
        ...
        <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md">
          <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-3.5">
            ...
            >
              <span className="rounded-md bg-[var(--color-accent)] px-1.5 py-0.5 text-white">Insu</span>
